        ...
        <div class="col-md-9">
            ...
            <div class="container bg-light" id="stdSup">
                ...
                <div class="form-group ">
                    <label for="usr">Project topic:</label>
                ...
                <div class="form-group">
                    <label for="pwd">Matric No:</label>
                    <input type="text" class="form-control" id="pwd">
                </div>
                <button type="submit" class="btn btn-success">Add project topic</button>
                ...
                <div class="form-group ">
                        ...
                        <br>
                        <label for="pwd">Matric No:</label>
                        <input type="numeric" class="form-control" id="pwd">
                    </div>
                    <button type="submit" class="btn btn-danger">Delete project topic</button>
                </div>
            ...
            <div class="bg-light container" id="lists">
                ...
                <div class="form-group ">
                        <div class="form-group">
                        <br>
                        <label for="pwd">Supervisor Name:</label>
                        <input type="numeric" class="form-control" id="pwd">
                    </div>
